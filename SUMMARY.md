...
* [Building the backend API with Laravel](iii.-development/building-the-backend-api-with-laravel.md)
* [Building the frontend with Vue and Nuxt](iii.-development/building-the-frontend-with-vue-and-nuxt.md)
* [Integrating the frontend and backend](iii.-development/integrating-the-frontend-and-backend.md)
* [Testing the application](iii.-development/testing-the-application.md)
